...
Soma integrates the input information from 
dendritic tree and inhibitory synapses.
In soma the whole input convolves to two 
influences: excitatory and inhibitory. 

Usually the ultimate convolution of input 
information to two influences reduces the 
input super-significantly and oversiplifies 
the processing that could put the system in 
non-functional state. 
This way the compromise between effectiveness 
